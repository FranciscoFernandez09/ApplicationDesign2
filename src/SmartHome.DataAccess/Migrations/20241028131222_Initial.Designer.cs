...
namespace SmartHome.DataAccess.Migrations
{
    ...
    [Migration("20241028131222_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.EFCoreClasses.HomeMemberNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.EFCoreClasses.MemberHomePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.Home", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.Session", b =>
                {
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.SmartDevices.DeviceImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.SmartDevices.SmartDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.SystemPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.SmartDevices.Camera", b =>
                {
                    b.HasBaseType("SmartHome.BusinessLogic.Domain.Entities.SmartDevices.SmartDevice");
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.Company", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.EFCoreClasses.HomeMemberNotification", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeMember", "HomeMember")
                        .WithMany()
                        .HasForeignKey("HomeMemberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.Notification", "Notification")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.EFCoreClasses.MemberHomePermission", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeMember", "Member")
                        .WithMany()
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomePermission", "Permission")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeDevice", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.SmartDevices.SmartDevice", "Device")
                        .WithOne()
                        .HasForeignKey("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeDevice", "DeviceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.Home", "Home")
                        .WithMany("Devices")
                        .HasForeignKey("HomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.Room", "Room")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeMember", b =>
                {
                    ...
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeMember", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.Notification", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.HomeManagement.HomeDevice", "HomeDevice")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.SmartDevices.DeviceImage", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.SmartDevices.SmartDevice", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.SmartDevices.SmartDevice", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.Company", "CompanyOwner")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartHome.BusinessLogic.Domain.Entities.User", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartHome.DataAccess.EFCoreClasses.RoleSystemPermission", b =>
                {
                    b.HasOne("SmartHome.BusinessLogic.Domain.Entities.SystemPermission", "Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
